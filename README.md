...
"Split phArticulatedBodyPart class into two classes to save memory on spu." "That allows us to use ragdolls created by Euphoria Studio without having to reserve ART agent pools for them"
